...
} else if (brittanisAge) {
  console.log (`Brittany is older`)
} else {
  console.leg (`They are the same age`)
}
...
if (temperature >= 80 && rain === true){
  ...
  console.log(`Choose something with long sleeves or a light jacket`)
}else if (temperature < 60 && rain === false){
  console.log(`Brrrr...Its chilly. Bring a jacket`)
}
...
while(score< passingScore){
  console.log (`Your score is not high enough mortal.`)
  score++
}
...
//on this code below I learned the boolean default is true so I can just eliminate the equals sign here to say changeMyMind is that same as changeMyMind === true
//CODE HERE
...
// log a countdown from the value of z to 1. Once you have logged the countdown, make sure you decrement z by 1.
